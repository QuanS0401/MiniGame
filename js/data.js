const LEVELS = [
    ...
    { group: "Hard", target: 30, numbers: [5, 5, 5, 5], hint: "Có thể ghép 2 số lại rồi cộng.", hintStep: ["5", "5"], fullSolution: ["5", "5", "-", "5", "*", "5",] },
    ...
    { group: "Super Hard", target: 36, numbers: [3, 6, 3, 6], hint: "hãy thử tạo ra 1 số khác bằng phép chia", hintStep: ["(", "6", "*", "6", "/", "3", ")"], fullSolution: ["(", "6", "*", "3", "/", "3", ")", "*", "3"] }, // 6 * (6 * 3/3)
