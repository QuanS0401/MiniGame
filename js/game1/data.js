const LEVELS = [
    ...
    { group: "Medium", target: 9, numbers: [9, 2, 6, 3], hint: "Tạo thêm một số 2 nữa", hintStep: ["9", "*", "6"], fullSolution: ["9", "*", "6", "/", "3", "/", "2"] }, // 9 * 6 / 3 / 2
    ...
    { group: "Super Hard", target: 36, numbers: [3, 8, 4, 3], hint: "phép trừ có thể kết hợp để tạo ra số 4", hintStep: ["(", "8", "-", "4", ")"], fullSolution: ["(", "8", "-", "4", ")", "*", "3", "*", "3"] }, // (8-4) * (3*3)
    { group: "Super Hard", target: 36, numbers: [3, 6, 3, 6], hint: "hãy thử tạo ra số 1 bằng phép chia", hintStep: ["3", "/", "3"], fullSolution: ["3", "/", "3", "*", "6", "*", "6" ] }, // 6 * 6 * 3/3
